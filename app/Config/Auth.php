...
class Auth extends \CodeIgniter\Config\BaseConfig
{
	 ...
	 */
	public $siteTitle                = 'Ken Coin';       // Site Title, example.com
	public $adminEmail               = 'info@pkarungari.co.ke'; // Admin Email, admin@example.com
	...
	public $userExpire               = 360;               // How long to remember the user (seconds). Set to zero for no expiration
	...
	public $forgotPasswordExpiration = 600;                /* The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
    ...
    public $userReturnType = '\App\Entities\User';
    public $userGroupsReturnType = '\App\Entities\Group';
	 ...
	 * Default: Auth\\Views\\auth\\email\\
	 *
	 * @var string
	 */
	public $emailTemplates = 'Auth\\Views\\auth\\email\\';
	...
	public $templates = [
		...
		'messages' => [
			'list'   => 'Auth\Views\Messages\list',
			'single' => 'Auth\Views\Messages\single',
		],
	];
}
