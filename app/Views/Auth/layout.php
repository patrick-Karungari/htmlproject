...
<html class="loading dark-layout" lang="en" data-layout="dark-layout" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Login Page - Ken Coin</title>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/pages/page-auth.css') ?>">
        <!-- END: Page CSS-->
                        ...
                        <div class="auth-inner row m-0">
                            ...
                            <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                                <div class="w-100 d-lg-flex align-items-center justify-content-center px-5 "><img
                                        id="myImage" class="img-fluid animation slide-out-right"
                                        src="<?php echo base_url('assets/images/pages/login-v2-dark.svg') ?>"
                                        alt="Login V2" /></div>
                            </div>
                            <!-- /Left Text-->
                            <!-- Login-->
