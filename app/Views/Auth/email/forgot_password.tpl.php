                                                        ...
                                                        <table border="0" cellpadding="15" cellspacing="0"
                                                                ...
                                                                <td>
                                                                    <div align="center">
                                                                        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.yourwebsite.com" style="height:58px;width:272px;v-text-anchor:middle;" arcsize="35%" strokeweight="0.75pt" strokecolor="#FFC727" fillcolor="#ffc727"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#393d47; font-family:Tahoma, Verdana, sans-serif; font-size:18px"><![endif]--><a
                                                                            href="<?php echo sprintf(base_url('auth/reset_password/' . $forgottenPasswordCode))?>"
                                                            ...
                                                            <tr>
                                                                <td bgcolor="#ffffff" align="left"
                                                                    ...
                                                                    <p style="margin: 0;">If that doesn't work, copy and
                                                                        paste the following link in your
                                                                        browser:</p>
                                                                </td>
                                                            </tr> <!-- COPY -->
                                                            <tr>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span style="font-size:13px;">If you
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span style="font-size:10px;">This link
                                                                                    will expire in 10 minutes. If you
                                                                                    continue to have
                                                                                    problems</span><br /><span
                                                                                    style="font-size:10px;">please feel
                                                                                    free to contact us at <a href="mailto:<?php echo sprintf($supportEmail) ?>
" rel="noopener" style="text-decoration: underline; color: #393d47;" target="_blank" title="<?php echo sprintf($supportEmail) ?>
"><?php echo sprintf($supportEmail) ?>
                                                                                    </a>.
                                                                                </span>
                                                                            </p>
                                                                        </div>
