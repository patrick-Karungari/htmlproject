    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item" id="dashboard"><a class="d-flex align-items-center"
                                                    href="<?php echo base_url('user/account') ?>"><i
            ...
            <li class=" nav-item"><a class="d-flex align-items-center"><i
                ...
                <ul class="menu-content">
                    <li id="investments"><a class="d-flex align-items-center"
                                            href="<?php echo base_url('user/invest') ?>"><i
                    ...
                    <li id="my-investments"><a class="d-flex align-items-center"
                                               href="<?php echo base_url('user/investments') ?>"><i
                                    data-feather="circle"></i><span
            ...
            <li id="deposits" class=" nav-item"><a class="d-flex align-items-center"
                                                   href="<?php echo base_url('user/deposits') ?>"><i
            ...
            <li class=" nav-item"><a class="d-flex align-items-center"><i
                            data-feather='trending-up'></i><span class="menu-title text-truncate"
                                                                 data-i18n="Investments">Transact</span></a>
                <ul class="menu-content">
                    <li id="transfer-btc"><a class="d-flex align-items-center"
                                             href="<?php echo base_url('user/transfers') ?>"><i
                                    data-feather="circle"></i><span
                    ...
                    <li id="transfer-money"><a class="d-flex align-items-center"
                                    ...
                                    data-feather="circle"></i><span
                                    class="menu-item text-truncate" data-i18n="Transfer Money">Transfer Money</span></a>
                    </li>
            ...
            <li class=" nav-item"><a class="d-flex align-items-center"><i
                ...
                <ul class="menu-content">
                    <li id="transfer-btc"><a class="d-flex align-items-center"
                                    ...
                                    data-feather="circle"></i><span
                                    class="menu-item text-truncate" data-i18n="Transfer BTC">Withdraw BTC</span></a>
                    </li>
                    <li id="transfer-money"><a class="d-flex align-items-center"
                                               href="<?php echo base_url('user/withdraws/money') ?>"><i
                                    data-feather="circle"></i><span
                                    class="menu-item text-truncate" data-i18n="Transfer Money">Withdraw Money</span></a>
                    </li>

                </ul>
            </li>
            <li id="withdrawals" class=" nav-item"><a class="d-flex align-items-center"
                                                      href="<?php echo base_url('user/withdraws') ?>"><i
                            data-feather="download-cloud"></i><span
            ...
            <li id="referrals" class=" nav-item"><a class="d-flex align-items-center"
                                                    href="<?php echo base_url('user/referrals') ?>"><i
