        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="card card-congratulations">
                <div class="card-body text-center">
                    <img src="<?php echo base_url('assets/images/elements/decore-left.png')?>"
                        class="congratulations-img-left" alt="card-img-left" />
                    <img src="<?php echo base_url('assets/images/elements/decore-right.png')?>"
                        ...
                        <li class="timeline-item">
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="media align-items-center">
                                    <img class="mr-1" src="<?php echo base_url('assets/images/icons/json.png')?>"
            ...
            <div class="card card-app-design">
                <div class="card-body">
                    ...
                    <div class="design-group pt-25">
                        ...
                        <div class="avatar">
                            <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-9.jpg')?>" width="34"
                        ...
                        <div class="avatar">
                            <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-14.jpg')?>" width="34"
                                height="34" alt="Avatar" />
                        </div>
                        <div class="avatar">
                            <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-7.jpg')?>" width="34"
                                height="34" alt="Avatar" />
                        </div>
