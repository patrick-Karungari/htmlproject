    ...
    <div class="col-12 col-sm-6 col-md-3 grid-margin stretch-card">
        <div class="card icon-card-primary">
            <div class="card-body">
                ...
                <small class="d-block mt-2"><a class="text-white" href="<?php echo site_url('user/deposits') ?>">Account balance</a></small>
            </div>
        </div>
    </div>
    <div class="col-12 col-sm-6 col-md-3 grid-margin stretch-card">
        <div class="card icon-card-success">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mt-3 flex-wrap">
                    <h3 class="font-weight-medium mb-0 mr-2"><?php echo number_format((new \App\Models\Investments())->where('user', $current_user->id)->where('status', 'pending')->selectSum('total', 'totalInvestments')->get()->getLastRow()->totalInvestments, 2) ?></h3>

                </div>
                <small class="d-block mt-2"><a class="text-white" href="<?php echo site_url('user/invest') ?>">Total investments</a></small>
            </div>
        </div>
    </div>
    <div class="col-12 col-sm-6 col-md-3 grid-margin stretch-card">
        <div class="card icon-card-info">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mt-3 flex-wrap">
                    <h3 class="font-weight-medium mb-0 mr-2"><?php echo number_format((new \App\Models\Investments())->where('user', $current_user->id)->where('status', 'completed')->selectSum('return', 'totalInvestments')->get()->getLastRow()->totalInvestments, 2) ?></h3>
                </div>
                <small class="d-block mt-2"><a class="text-white" href="<?php echo site_url('user/invest/investments') ?>">Total profits</a></small>
            </div>
        </div>
    </div>
    <div class="col-12 col-sm-6 col-md-3 grid-margin stretch-card">
        <div class="card icon-card-dark">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mt-3 flex-wrap">
                    <h3 class="font-weight-medium mb-0 mr-2"><?php echo number_format((new \App\Models\Withdraws())->where('user', $current_user->id)->where('status', 'completed')->selectSum('amount', 'totalWithdraws')->get()->getLastRow()->totalWithdraws, 2) ?></h3>

                </div>
                <small class="d-block mt-2"><a class="text-white" href="<?php echo site_url('user/withdraws') ?>">Total amount withdrawn</a> </small>
            </div>
        </div>
    </div>
    <div class="col-12 col-sm-6 col-md-3 grid-margin stretch-card">
        <div class="card icon-card-info">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mt-3 flex-wrap">
                    <h3 class="font-weight-medium mb-0 mr-2"><?php echo number_format((new \App\Models\Deposits())->where('user', $current_user->id)->where('status', 'completed')->selectSum('amount', 'totalWithdraws')->get()->getLastRow()->totalWithdraws, 2) ?></h3>

                </div>
                <small class="d-block mt-2"><a class="text-white" href="<?php echo site_url('user/deposits') ?>">Total amount deposited</a> </small>
            </div>
        </div>
    </div>
    <div class="col-12 col-sm-6 col-md-3 grid-margin stretch-card">
        ...
        <div class="card icon-card-dark">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <p class="font-weight-medium mb-0" data-toggle="tooltip" data-placement="right" title="This is the accummulative bonus earned by all downlines. Bonus amounts reflect to your account balance upon completion">Total Accumulative Bonus</p>
                </div>
                <div class="d-flex align-items-center mt-3 flex-wrap">
                    <h3 class="font-weight-medium mb-0 mr-2"><?php echo number_format((new \App\Libraries\Metrics())->getUserReferralBonusTotals($current_user->id), 2) ?></h3>

                </div>
<!--                <small class="d-block mt-2"><a class="text-white" href="--><?php //echo site_url('user/transactions?type=referral') ?><!--">Total amount withdrawn</a> </small>-->
            </div>
        </div>
    </div>
</div>
