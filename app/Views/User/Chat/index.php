...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/pages/app-chat-list.css') ?>">
<!-- END: Page CSS-->
            ...
            <div class="sidebar-content">
                ...
                <div id="users-list" class="chat-user-list-wrapper list-group">
                    ...
                    <ul class="chat-users-list chat-list media-list">
                        ...
                        <li>
                            <span class="avatar"><img
                                    src="<?php echo base_url('assets/images/portrait/small/avatar-s-7.jpg') ?>"
                                    height="42" width="42" alt="Generic placeholder image" />
                        ...
                        <li>
                            <span class="avatar"><img
                                    src="<?php echo base_url('assets/images/portrait/small/avatar-s-8.jpg') ?>"
                                    height="42" width="42" alt="Generic placeholder image" />
                    ...
                    <ul class="chat-users-list contact-list media-list">
                        ...
                        <li>
                            <span class="avatar"><img
                                    src="<?php echo base_url('assets/images/portrait/small/avatar-s-5.jpg') ?>"
                                    height="42" width="42" alt="Generic placeholder image" />
                            </span>
                            <div class="chat-info">
                        ...
                        <li>
                            <span class="avatar"><img
                                    src="<?php echo base_url('assets/images/portrait/small/avatar-s-9.jpg') ?>"
                                    height="42" width="42" alt="Generic placeholder image" />
                            </span>
                            <div class="chat-info">
                        ...
                        <li>
                            <span class="avatar"><img
                                    src="<?php echo base_url('assets/images/portrait/small/avatar-s-14.jpg') ?>"
                                    height="42" width="42" alt="Generic placeholder image" />
                            </span>
                            <div class="chat-info">
                        ...
                        <li>
                            <span class="avatar"><img
                                    src="<?php echo base_url('assets/images/portrait/small/avatar-s-17.jpg') ?>"
                                    height="42" width="42" alt="Generic placeholder image" />
                            </span>
                            <div class="chat-info">
                        ...
                        <li>
                            <span class="avatar"><img
                                    src="<?php echo base_url('assets/images/portrait/small/avatar-s-13.jpg') ?>"
                                    height="42" width="42" alt="Generic placeholder image" />
                            </span>
                            <div class="chat-info">
...
<!-- BEGIN: Page JS-->
<script src="<?php echo base_url('assets/js/scripts/pages/app-chat.js')?>">
</script>
