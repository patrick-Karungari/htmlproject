...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/vendors/css/pickers/flatpickr/flatpickr.min.css')?>">
<!-- END: Vendor CSS-->

<!-- BEGIN: Page CSS-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/core/menu/menu-types/vertical-menu.css')?>">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/plugins/forms/pickers/form-pickadate.css')?>">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/plugins/forms/pickers/form-flat-pickr.css')?>">
...
<script src="<?php echo base_url('assets/vendors/js/pickers/flatpickr/flatpickr.min.js')?>"></script>
<!-- END: Page Vendor JS-->
