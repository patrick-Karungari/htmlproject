                    ...
                    <div class="modal-body flex-grow-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname"
                                placeholder="John Doe" name="user-firstname" aria-label="John Doe"
                                aria-describedby="basic-icon-default-fullname2" />
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="basic-icon-default-fullname">Last Name</label>
                            <input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname"
                                placeholder="John Doe" name="user-lastname" aria-label="John Doe"
                                aria-describedby="basic-icon-default-fullname2" />
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="basic-icon-default-uname">Username</label>
                            <input type="text" id="basic-icon-default-uname" class="form-control dt-uname"
                                placeholder="@someone" aria-label="jdoe1" aria-describedby="basic-icon-default-uname2"
                                name="user-name" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="basic-icon-default-email" class="form-control dt-email"
                                placeholder="(__) ________" aria-label="john.doe@example.com"
                                aria-describedby="basic-icon-default-email2" name="phone" />
                            <small class="form-text text-muted"> Enter country code without + and the preceding
                                digits</small>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="user-role">Country</label>
                        ...
                        <button type="submit" disabled class="btn btn-primary mr-1 data-submit">Submit</button>
