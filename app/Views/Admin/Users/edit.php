...
" alt="users avatar" class="user-avatar users-avatar-shadow rounded mr-2 my-25 cursor-pointer" height="90"
                            width="90" />
...
<script src="../../../assets/vendors/js/forms/validation/jquery.validate.min.js">
</script>
<script src="../../../assets/vendors/js/pickers/flatpickr/flatpickr.min.js">
</script>
<!-- END: Page Vendor JS-->
<!-- BEGIN: Page JS-->
<script src="../../../assets/js/scripts/pages/app-user-edit.js"></script>
<script src="../../../assets/js/scripts/components/components-navs.js"></script>
<!-- END: Page JS-->
