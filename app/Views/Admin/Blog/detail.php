            ...
            <div class="content-body">
                ...
                <div class="blog-detail-wrapper">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <img src="<?php echo base_url('assets/images/banner/banner-12.jpg')?>" class="img-fluid card-img-top" alt="Blog Detail Pic" />
                                <div class="card-body">
                                    ...
                                    <div class="media">
                                        <div class="avatar mr-2">
                                            <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-6.jpg')?>" width="60" height="60" alt="Avatar" />
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar mr-75">
                                            <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-9.jpg')?>" width="38" height="38" alt="Avatar" />
                                        </div>
                                        <div class="media-body">
