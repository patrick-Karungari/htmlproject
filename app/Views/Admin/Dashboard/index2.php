                ...
                <div class="row match-height">
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="card card-congratulation-medal">
                            <div class="card-body">
                                <h5>Congratulations 🎉 <?php echo $current_user->name ?>!</h5>
                                <p class="card-text font-small-3">You have won gold medal</p>
                                <h3 class="mb-75 mt-2 pt-50">
                                    <a href="javascript:void(0);">$48.9k</a>
                                </h3>
                                <button type="button" class="btn btn-primary">View Sales</button>
                                <img src="<?php echo base_url('assets/images/illustration/badge.svg')?>"
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo base_url('assets/images/icons/toolbox.svg')?>"
                                                                    alt="Toolbar svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo base_url('assets/images/icons/parachute.svg')?>"
                                                                    alt="Parachute svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo base_url('assets/images/icons/brush.svg')?>"
                                                                    alt="Brush svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo base_url('assets/images/icons/star.svg')?>"
                                                                    alt="Star svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo base_url('assets/images/icons/book.svg')?>"
                                                                    alt="Book svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo base_url('assets/images/icons/rocket.svg')?>"
                                                                    alt="Rocket svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo base_url('assets/images/icons/speaker.svg')?>"
                                                                    alt="Speaker svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="card card-developer-meetup">
                            <div class="meetup-img-wrapper rounded-top text-center">
                                <img src="<?php echo base_url('assets/images/illustration/email.svg')?>"
                            ...
                            <div class="card-body">
                                ...
                                <div class="avatar-group">
                                    ...
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                        ...
                                        <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-20.jpg')?>"
                                            alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                        ...
                        <div class="card card-browser-states">
                            ...
                            <div class="card-body">
                                <div class="browser-states">
                                    <div class="media">
                                        <img src="<?php echo base_url('assets/images/icons/google-chrome.png')?>"
                                ...
                                <div class="browser-states">
                                    <div class="media">
                                        <img src="<?php echo base_url('assets/images/icons/mozila-firefox.png')?>"
                                ...
                                <div class="browser-states">
                                    <div class="media">
                                        <img src="<?php echo base_url('assets/images/icons/apple-safari.png')?>"
                                ...
                                <div class="browser-states">
                                    <div class="media">
                                        <img src="<?php echo base_url('assets/images/icons/internet-explorer.png')?>"
                                ...
                                <div class="browser-states">
                                    <div class="media">
                                        <img src="<?php echo base_url('assets/images/icons/opera.png')?>"
