            ...
            <div class="col-12">
                <div class="card profile-header mb-2">
                    ...
                    <img class="card-img-top"
                         src="<?php echo base_url('assets/images/profile/user-uploads/timeline.jpg') ?>"
                    ...
                    <div class="position-relative">
                        ...
                        <div class="profile-img-container d-flex align-items-center">
                            <div class="profile-img">
                                <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-2.jpg') ?>"
                                     class="rounded img-fluid" alt="Card image"/>
                            </div>
                            <!-- profile title -->
                            <div class="profile-title ml-3 position-relative">
                                <h2 class="text-white" id="name_p"></h2>
                                <p class="text-white">Admin/Content Creator </p>
                ...
                <div class="col-lg-3 col-12 order-2 order-lg-1">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Tart I love sugar plum I love oat cake. Sweet ⭐️ roll caramels I love jujubes. Topping
                                cake wafer.
                            </p>
                            <div class="mt-2">
                        ...
                        <div class="card-body profile-suggestion">
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-1">
                                <div class="avatar mr-1">
                                    <img src="<?php echo base_url('assets/images/avatars/12-small.png') ?>"
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-1">
                                <div class="avatar mr-1">
                                    <img src="<?php echo base_url('assets/images/avatars/1-small.png') ?>" alt="avatar"
                                         height="40" width="40"/>
                                </div>
                                <div class="profile-user-info">
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-1">
                                <div class="avatar mr-1">
                                    <img src="<?php echo base_url('assets/images/avatars/10-small.png') ?>" alt="avatar"
                                         height="40" width="40"/>
                                </div>
                                <div class="profile-user-info">
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-1">
                                <div class="avatar mr-1">
                                    <img src="<?php echo base_url('assets/images/avatars/3-small.png') ?>"
                                         alt="avatar img" height="40" width="40"/>
                                </div>
                                <div class="profile-user-info">
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-1">
                                <div class="avatar mr-1">
                                    <img src="<?php echo base_url('assets/images/avatars/5-small.png') ?>"
                                         alt="avatar img" height="40" width="40"/>
                                </div>
                                <div class="profile-user-info">
                            ...
                            <div class="d-flex justify-content-start align-items-center">
                                <div class="avatar mr-1">
                                    <img src="<?php echo base_url('assets/images/avatars/6-small.png') ?>"
                                         alt="avatar img" height="40" width="40"/>
                                </div>
                                <div class="profile-user-info">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="profile-twitter-feed mt-1">
                                ...
                                <p class="card-text mb-50">I love cookie chupa chups sweet tart apple pie ⭐️ chocolate
                                    bar.</p>
                                <a href="javascript:void(0)">
                            ...
                            <div class="profile-twitter-feed mt-2">
                                <div class="d-flex justify-content-start align-items-center mb-1">
                                    <div class="avatar mr-1">
                                        <img src="<?php echo base_url('assets/images/avatars/1-small.png') ?>"
                                             alt="avatar img" height="40" width="40"/>
                                    </div>
                                    <div class="profile-user-info">
                ...
                <div class="col-lg-6 col-12 order-1 order-lg-2">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-start align-items-center mb-1">
                                <!-- avatar -->
                                <div class="avatar mr-1">
                                    <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-18.jpg') ?>"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-group ml-1">
                                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-1.jpg') ?>"
                                            ...
                                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                                 ...
                                                 class="avatar pull-up">
                                                <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-3.jpg') ?>"
                                                     alt="Avatar" height="26" width="26"/>
                                            </div>
                                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                                 data-placement="bottom" data-original-title="George Nordic"
                                                 class="avatar pull-up">
                                                <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-5.jpg') ?>"
                                                     alt="Avatar" height="26" width="26"/>
                                            </div>
                                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                                 data-placement="bottom" data-original-title="Vinnie Mostowy"
                                                 class="avatar pull-up">
                                                <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-4.jpg') ?>"
                                                     alt="Avatar" height="26" width="26"/>
                                            </div>
                                        </div>
                            ...
                            <div class="d-flex align-items-start mb-1">
                                <div class="avatar mt-25 mr-75">
                                    <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-6.jpg') ?>"
                            ...
                            <div class="d-flex align-items-start mb-1">
                                <div class="avatar mt-25 mr-75">
                                    <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-8.jpg') ?>"
                                         alt="Avatar" height="34" width="34"/>
                                </div>
                                <div class="profile-user-info w-100">
                                    <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-1">
                                <div class="avatar mr-1">
                                    <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-22.jpg') ?>"
                                         alt="avatar img" height="50" width="50"/>
                                </div>
                                <div class="profile-user-info">
                            ...
                            <!-- post img -->
                            <img class="img-fluid rounded mb-75"
                                 src="<?php echo base_url('assets/images/profile/post-media/25.jpg') ?>"
                                 alt="avatar img"/>
                            <!--/ post img -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-1">
                                <div class="avatar mr-1">
                                    <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-15.jpg') ?>"
                                         alt="avatar img" height="50" width="50"/>
                                </div>
                                <div class="profile-user-info">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-group ml-1">
                                            ...
                                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                                 ...
                                                 class="avatar pull-up">
                                                <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-7.jpg') ?>"
                                                     alt="Avatar" height="26" width="26"/>
                                            </div>
                                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                                                 data-placement="bottom" data-original-title="Julee Rossignol"
                                                 class="avatar pull-up">
                                                <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-10.jpg') ?>"
                                                     alt="Avatar" height="26" width="26"/>
                                            </div>
                                            <div data-toggle="tooltip" data-popup="tooltip-custom"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-6 profile-latest-img">
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url('assets/images/profile/user-uploads/user-13.jpg') ?>"
                                             class="img-fluid rounded" alt="avatar img"/>
                                    </a>
                                </div>
                                <div class="col-md-4 col-6 profile-latest-img">
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url('assets/images/profile/user-uploads/user-02.jpg') ?>"
                                             class="img-fluid rounded" alt="avatar img"/>
                                    </a>
                                </div>
                                <div class="col-md-4 col-6 profile-latest-img">
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url('assets/images/profile/user-uploads/user-03.jpg') ?>"
                                             class="img-fluid rounded" alt="avatar img"/>
                                    </a>
                                </div>
                                <div class="col-md-4 col-6 profile-latest-img">
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url('assets/images/profile/user-uploads/user-04.jpg') ?>"
                                             class="img-fluid rounded" alt="avatar img"/>
                                    </a>
                                </div>
                                <div class="col-md-4 col-6 profile-latest-img">
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url('assets/images/profile/user-uploads/user-05.jpg') ?>"
                                             class="img-fluid rounded" alt="avatar img"/>
                                    </a>
                                </div>
                                <div class="col-md-4 col-6 profile-latest-img">
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url('assets/images/profile/user-uploads/user-06.jpg') ?>"
                                             class="img-fluid rounded" alt="avatar img"/>
                                    </a>
                                </div>
                                <div class="col-md-4 col-6 profile-latest-img">
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url('assets/images/profile/user-uploads/user-07.jpg') ?>"
                                             class="img-fluid rounded" alt="avatar img"/>
                                    </a>
                                </div>
                                <div class="col-md-4 col-6 profile-latest-img">
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url('assets/images/profile/user-uploads/user-08.jpg') ?>"
                                             class="img-fluid rounded" alt="avatar img"/>
                                    </a>
                                </div>
                                <div class="col-md-4 col-6 profile-latest-img">
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url('assets/images/profile/user-uploads/user-09.jpg') ?>"
                                             class="img-fluid rounded" alt="avatar img"/>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-start align-items-center mt-2">
                                <div class="avatar mr-75">
                                    <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-9.jpg') ?>"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="profile-polls-info mt-2">
                                ...
                                <div class="avatar-group my-1">
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                        ...
                                        <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-12.jpg') ?>"
                                             alt="Avatar" height="26" width="26"/>
                                    </div>
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    ...
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                        ...
                                        <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-11.jpg') ?>"
                                             alt="Avatar" height="26" width="26"/>
                                    </div>
                                </div>
                                <!--/ avatar group with tooltip -->
                            ...
                            <div class="profile-polls-info mt-2">
                                ...
                                <!-- progressbar -->
                                <div class="progress progress-bar-primary my-50">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="16" aria-valuemin="16"
                                ...
                                <div class="avatar-group mt-1">
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                         data-original-title="Liliana Pecor" class="avatar pull-up">
                                        <img src="<?php echo base_url('assets/images/portrait/small/avatar-s-9.jpg') ?>"
                                             alt="Avatar" height="26" width="26"/>
                                    </div>
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                    ...
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                                         data-original-title="Jonathan Lyons" class="avatar pull-up">
                                        <img style=" color: blue" src="<?php echo base_url('assets/images/portrait/small/avatar-s-8.jpg') ?>"
                                             alt="Avatar" height="26" width="26"/>
                                    </div>
                                </div>
                                <!--/ avatar group with tooltips-->
