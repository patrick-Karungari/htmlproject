                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">New Payment to  <?php echo $withdraw->user->name; ?></h5>
                                                ...
                                                <form class ="d-inline "method='post' action="<?php echo site_url('admin/withdraws/manualwithdraw') ?>">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group" >
                                                            <label>Amount</label>
                                                            <input  id ="amount"  type="number" name="amount" value="<?php echo $withdraw->amount ?>" class="form-control" required />
                                                        </div>
                                                        <div class="form-group" >
