...
class AuthModel
{
	...
	public function getUserByActivationCode(string $userCode)
	{
		...
		$user = (new Users())->where('activation_selector', $token->selector)->get()->getFirstRow($this->config->userReturnType);
	 ...
	 * @author Mathew
	 */
	public function deactivate(int $id=0, int $deactivated_by = null): bool
	{
