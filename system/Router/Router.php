...
class Router implements RouterInterface
{
	 ...
	 * @var string
	 */
	protected $indexPage = 'system.php';
	...
	/**
	 * Sets the value that should be used to match the system.php file. Defaults
	 * to system.php but this allows you to modify it in case your are using
