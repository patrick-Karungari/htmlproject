...
$(window).on('load', function () {
  ...
  var $balanceOrderChart = document.querySelector('#balanceorder-chart');
  ...
  // Balance Order Received Chart
  // ----------------------------------

  balanceOrderChartOptions = {
    chart: {
      height: 100,
      type: 'area',
      toolbar: {
  ...
  balanceOrderChart = new ApexCharts($balanceOrderChart, balanceOrderChartOptions);
  balanceOrderChart.render();
